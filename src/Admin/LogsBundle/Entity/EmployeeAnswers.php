...
class EmployeeAnswers
{
    ...
    /**
     * @var \Admin\LogsBundle\Entity\Questions
     *
     * @ORM\ManyToOne(targetEntity="Admin\LogsBundle\Entity\Questions")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Admin\LogsBundle\Entity\UserAccount
     *
     * @ORM\ManyToOne(targetEntity="Admin\LogsBundle\Entity\UserAccount")
     * @ORM\JoinColumns({
